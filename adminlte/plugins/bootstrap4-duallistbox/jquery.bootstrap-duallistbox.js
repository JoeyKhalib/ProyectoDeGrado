...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: 'Quedan en Total {0}',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="badge badge-warning">Buscar</span> {0} from {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: 'Jugadores Vacio',                                                        // when there are no options present in the list
