...
<hr>
 ...
 <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url();?>index.php/jugador/opcionesEntrenador" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Gestionar Jugador</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo base_url();?>index.php/jugador/imprimirJugadoresEntre" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
         ...
         <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url();?>index.php/cursos/agregarCEntr" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Crear de Cursos</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?php echo base_url();?>index.php/cursos/listaCursosEntr" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
<li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url();?>index.php/evento/listaEventosEntr" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
