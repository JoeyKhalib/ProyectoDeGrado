          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">Nombre del Entrenador</h3>

                <p class="text-muted text-center">Rol del Entrenador</p>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
               ...
               <p class="text-muted">
                ...
                <p class="text-muted">Carnet de identidad.</p>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
