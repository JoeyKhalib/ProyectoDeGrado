                ...
                <div class="text-center">
                        ...
                        if ($foto=="") {
                          //mostrar una imagen por defecto
                           ?> 
                           <img src="<?php echo base_url(); ?>uploads/usuariosFotos/perfil.jpg" alt="user-avatar" class="img-circle img-fluid">  
                           <?php
                        }
                        else {
                          //mostrar la foto del usuario
                            ?> 
                             <img src="<?php echo base_url(); ?>uploads/usuariosFotos/<?php echo $foto;?>" alt="user-avatar" class="img-circle img-fluid">     
                            <?php
                        }
                      ?> 
