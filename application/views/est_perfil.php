                  ...
                  <div class="text-center">
                        ...
                        if ($foto=="") {
                          //mostrar una imagen por defecto
                           ?> 
                           <img class="profile-user-img img-fluid img-circle" width="100" height="100" src="<?php echo base_url(); ?>uploads/usuarios/perfil.jpg" alt="User profile picture">
                           <?php
                        }
                        else {
                          //mostrar la foto del usuario
                            ?> 
                             <img class="profile-user-img img-fluid img-circle" width="100" height="100" src="<?php echo base_url(); ?>uploads/usuarios/<?php echo $foto; ?>" alt="User profile picture">      
                            <?php
                        }
                      ?> 
         ...
         ?>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">Lugar de Residencia</p>
